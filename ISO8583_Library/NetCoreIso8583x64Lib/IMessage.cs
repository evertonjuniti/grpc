namespace NetCoreIso8583x64Lib
{
    ...
    public interface IMessage : IDisposable
    {
        ...
        /// <param name="message">The message to be set on a field</param>
        void SetMessage(ISO_8583_1987 field, string message);
        ...
        /// <param name="message">The message to be set on a field</param>
        void SetMessage(ISO_8583_1993 field, string message);
        ...
        /// Sets a collection of messages in a limit of 129 fields available. If a message was already set through SetMessage or SetMessages, this method will replace the old message with the new one if in the same position (TKey)
        /// </summary>
        /// <param name="messages">A collection of messages with a ISO_8583_1987 enum field representation as a TKey (ISO_8583_1987) and a message as a TValue (string) of an IDictionary object</param>
        void SetMessages(IDictionary<ISO_8583_1987, string> messages);
        ...
        /// Sets a collection of messages in a limit of 129 fields available. If a message was already set through SetMessage or SetMessages, this method will replace the old message with the new one if in the same position (TKey)
        /// </summary>
        /// <param name="messages">A collection of messages with a ISO_8583_1993 enum field representation as a TKey (ISO_8583_1993) and a message as a TValue (string) of an IDictionary object</param>
        void SetMessages(IDictionary<ISO_8583_1993, string> messages);
